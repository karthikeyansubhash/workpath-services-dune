...
import com.hp.ext.service.device.Capabilities;

/**
 * The Facade for the Device Service Capabilities resource
 */
public class CapabilitiesResourceFacade extends BaseResourceFacade implements CapabilitiesResource {
    ...
    public CompletableFuture<Capabilities> getAsync() throws URISyntaxException {
