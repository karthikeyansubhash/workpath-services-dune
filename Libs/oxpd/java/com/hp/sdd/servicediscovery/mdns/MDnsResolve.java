...
/**
 * Created by jsanchez on 23/01/2017.
 */
...
public class MDnsResolve implements IDiscovery {
    ...
    private static final byte[] REQ_FLAGS = {0x01,0x00};
    ...
    private static final byte[] REQ_ANY_TYPE= {(byte)0x00,(byte)0xff};//

    private static final byte[] REQ_IN_CLASS_QU_TRUE = { (byte)0x80, 0x01 };
    private static final byte[] REQ_IN_CLASS_QU_FALSE = {(byte)0x00,(byte)0xff};
    ...
    public MDnsResolve(String[] serviceList) {
        ...
        for(String serviceName : mServiceList) {
            ...
            try {
                ...
                for(String servicePart : serviceSplits) {
                    ...
                    //Do not send "local" in the service name.
                    if(!servicePart.contains("local")) {
                ...
                mdnsBuffer.write(REQ_ANY_TYPE);
                mdnsBuffer.write(REQ_IN_CLASS_QU_FALSE);
