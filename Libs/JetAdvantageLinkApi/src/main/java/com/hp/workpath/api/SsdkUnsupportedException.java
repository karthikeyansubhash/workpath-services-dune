...
public class SsdkUnsupportedException extends Exception {
    /**
     * <p>Indicates that Workpath SDK is not installed.</p>
     */
    public static final int LIBRARY_NOT_INSTALLED = 2;

    /**
     * <p>Indicates that Workpath SDK needs to be updated to compatible version which is using by an application.</p>
     */
     ...
     *                  ( VENDOR_NOT_SUPPORTED, DEVICE_NOT_SUPPORTED, LIBRARY_NOT_INSTALLED, LIBRARY_UPDATE_IS_REQUIRED, LIBRARY_UPDATE_IS_RECOMMENDED )
    ...
    /**
     * <p>Returns enumeration of error type when Workpath SDK is not initialized.</p>
     *
