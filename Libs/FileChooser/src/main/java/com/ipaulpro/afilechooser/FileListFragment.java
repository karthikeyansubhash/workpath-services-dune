...
public class FileListFragment extends ListFragment implements
     ...
     */
    public static FileListFragment newInstance(String path, String mode) {
        FileListFragment fragment = new FileListFragment();
        Bundle args = new Bundle();
        args.putString(FileUtils.PATH, path);
        args.putString(FileUtils.INTENT_SELECT, mode);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPath = getArguments() != null ? getArguments().getString(
                FileUtils.PATH) : Environment
                .getExternalStorageDirectory().getAbsolutePath();
        mMode = getArguments() != null ? getArguments().getString(
                FileUtils.INTENT_SELECT) : FileUtils.FILE;
    ...
    public Loader<List<File>> onCreateLoader(int id, Bundle args) {
        return new FileLoader(getActivity(), mPath, mMode);
    }
