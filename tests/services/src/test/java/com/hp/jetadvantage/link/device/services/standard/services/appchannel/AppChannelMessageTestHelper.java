...
public class AppChannelMessageTestHelper {
    public static AppChannelMessage.ChannelMessage createPayloadMessage(String channelId, String typeGun,
                                                                        String message) {
    ...
    public static AppChannelSetup createAppChannelSetup(String channelId, String packageId, String serviceTypeGun,
                                                  String payloadGun) {
    ...
    public static String makeTestOperationCallbackServiceMessage(String channelId, String serviceCallId, String usbCallbackPayload) {
        return "{\n" +
                "    \"channelMessage\": {\n" +
                "        \"channelId\": \""+channelId+"\",\n" +
                "        \"message\": {\n" +
    ...
    public static String makeTestRegistrationCallbackServiceMessage(String channelId, String serviceCallId, String usbRegistrationPayload) {
        return "{\n" +
                "    \"channelMessage\": {\n" +
                "        \"channelId\": \""+channelId+"\",\n" +
                "        \"message\": {\n" +
